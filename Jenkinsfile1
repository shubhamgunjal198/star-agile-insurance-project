node{
    ...
    stage('git code checkout'){
        try{
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'shubhamgunjal198@gmail.com'
        }
    }
    ...
    stage('Pushing it ot the DockerHub'){
       ...
       // sh "${dockerCMD} login -u shubhamgunjal1619 -p ${dockerHubPassword}"
        sh "${dockerCMD} login -u shubhamgunjal1619 -p ${dockerHubPassword}"
        sh "${dockerCMD} push shubhamgunjal1619/insure-me:${tagName}"
